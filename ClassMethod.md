...
desc：set alerm  
arg ：func(id)：Method that is called when it is time alm：msec  
ret ：－－－  
Detail：  
When you want to pass the data other than the id to func (id) is  
to change the func around the sample,  
